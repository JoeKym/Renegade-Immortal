...
export const searchableData: SearchResult[] = [
  ...
  { title: "Zhou Ru", category: "Character", description: "Li Muwan's soul-vessel successor and Wang Lin's protected junior", path: "/characters?q=Zhou+Ru", keywords: ["li muwan vessel", "zhou ru", "little ru'er"] },
  { title: "Li Qianmei", category: "Character", description: "Dream Dao cultivator whose soul blood sustained Wang Lin", path: "/characters?q=Li+Qianmei", keywords: ["li qian mei", "dream dao", "qianmei"] },
  { title: "Du Jian", category: "Character", description: "Red Division disciple turned loyal celestial guard", path: "/characters?q=Du+Jian", keywords: ["dujian", "celestial guard", "red division"] },
  { title: "Horned Thunder Beast", category: "Character", description: "Ancient thunder mount and guardian beast under Wang Lin", path: "/characters?q=Horned+Thunder+Beast", keywords: ["thunder beast", "spirit beast", "mount"] },
  { title: "Master Flamespark", category: "Character", description: "Yan Leizi, the tactical mastermind of the Thunder Celestial Temple", path: "/characters?q=Master+Flamespark", keywords: ["yan leizi", "flamespark", "thunder celestial temple"] },
  { title: "Yan Leizi", category: "Character", description: "Master Flamespark and strategist of the Thunder Celestial Temple", path: "/characters?q=Yan+Leizi", keywords: ["master flamespark", "yan leizi", "thunder celestial temple"] },
  { title: "Master Lu Fu", category: "Character", description: "Ancient ancestor of Allheaven and key advisor in the outer realm crisis", path: "/characters?q=Master+Lu+Fu", keywords: ["lu fu", "allheaven ancestor", "master lu fu"] },
  { title: "Demon Emperor Gu Yundun", category: "Character", description: "Supreme ruler of Sky Demon Country and ancient demon commander", path: "/characters?q=Demon+Emperor+Gu+Yundun", keywords: ["gu yundun", "sky demon country", "demon emperor"] },
  ...
  { title: "Search all results", category: "Search", description: "Search across characters, daos, artifacts, news, episodes, communities, and pages across the site", path: "/search", keywords: ["global search", "site search", "search everything", "find anything", "search all"], type: "search" },
  { title: "Community Hub", category: "Page", description: "Browse all communities, groups, and fans discussing Renegade Immortal", path: "/communities", keywords: ["community hub", "groups", "clubs", "forums", "cultivators"] },
  { title: "News Feed", category: "Page", description: "Official updates, media drops, and Renegade Immortal announcements", path: "/news", keywords: ["updates", "release news", "episode news", "announcements", "latest news"] },
  { title: "Social Feed", category: "Page", description: "Posts, media, and social content from Renegade Immortal communities and platforms", path: "/feed", keywords: ["feed", "posts", "videos", "photos", "social media", "community updates"] },
  { title: "Donghua Episodes", category: "Page", description: "Browse episode tracks, release data, and donghua watch pages", path: "/watch", keywords: ["episodes", "watch list", "donghua episodes", "anime seasons", "watch now"] },
  { title: "Series Index", category: "Page", description: "Explore related donghua series and episode sections across the site", path: "/donghua-series", keywords: ["series list", "anime catalog", "other series", "donghua list"] },
  { title: "Renegade Immortal", category: "Series", description: "The main title and donghua adaptation around Wang Lin's cultivation path", path: "/donghua?q=Renegade+Immortal", keywords: ["xian ni", "renegade immortal", "仙逆", "main series"] },
  { title: "Battle Through the Heavens", category: "Series", description: "Related cultivation series and donghua recommendations in the site catalog", path: "/donghua-series?series=battle-through-the-heavens", keywords: ["battle through the heavens", "dou po cang qiong", "battle through", "doupo cangqiong"] },
  { title: "Swallowed Star", category: "Series", description: "Cultivation-era companion series highlighted in the donghua catalog", path: "/donghua-series?series=swallowed-star", keywords: ["swallowed star", "tunshi xingkong", "吞噬星空"] },
  { title: "Perfect World", category: "Series", description: "Another major serial in the site catalog connected to the cultivation multiverse", path: "/donghua-series?series=perfect-world", keywords: ["perfect world", "wanmei shijie", "完美世界"] },
  { title: "The Miasma War", category: "Series", description: "Special bridge arc within the Eclipse of Illusion storyline", path: "/donghua-series?series=the-miasma-war", keywords: ["miasma war", "eclipse of illusion special", "special war"] },
  { title: "User Profile", category: "Profile", description: "View user profiles, creators, and community members", path: "/members", keywords: ["members", "user profiles", "cultivators", "community member"] },
];
